...
| Federal contact display | Config-driven | Until NEXT_PUBLIC_FEDERAL_CONTACT_EMAIL is set, federal surfaces show "Contact: bevierstrategic.com/government" instead of printing a personal address prominently. |
