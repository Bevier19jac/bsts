#!/usr/bin/env python3
"""Apply the approved copy-only pass with exact matches and no partial writes.

Preserves assets, CSS, assessment questions/routing, pricing, certification
status, and provider-side form delivery. Safe to run again after application.
"""
...
patch(services_page, '''            <div className="mt-7 flex justify-center">
              ...
              <a href="/#assessment" className="btn-ghost-form px-6 py-3">Start the Assessment</a>
            </div>''')
